...
def circle():
    canvas.coords(r, (0, 0, 0, 0))
    canvas.coords(t, (0, 0, 0, 0, 0, 0))
    canvas.itemconfig(c, fill='magenta', outline='white')
    canvas.coords(c, (45,45,240,240))
    text.delete(1.0, END)
...
b_clear = Button(text="Очистити", width=15, command=clear_all)
...
c = canvas.create_oval(0,0,0,0, width=2)
